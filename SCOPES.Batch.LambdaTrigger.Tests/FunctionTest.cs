...
using SCOPES.Batch.LambdaTrigger;
using Amazon.SimpleNotificationService;

namespace SCOPES.Batch.LambdaTrigger.Tests
{
    public class FunctionTest
    {
        ...
        public async Task TestS3EventLambdaFunction()
        {
            ...
            IAmazonSimpleNotificationService snsService = new AmazonSimpleNotificationServiceClient();

            var bucketName = "lambda-SCOPES.Batch.LambdaTrigger-".ToLower() + DateTime.Now.Ticks;
            var key = "text.txt";
            ...
            try
            {
                ...
                var function = new Function(s3Client, snsService);
                var id = await function.FunctionHandler(s3Event, null);
